...
#   set(CAFFE_DEPENDENCIES_ROOT_DIR ${USERPROFILE_DIR}/.caffe/dependencies CACHE PATH "Prebuild depdendencies root directory")
  set(CAFFE_DEPENDENCIES_ROOT_DIR ${CMAKE_SOURCE_DIR}/../caffe3rdparty/dependencies CACHE PATH "Prebuild depdendencies root directory")
...
if(USE_PREBUILT_DEPENDENCIES)
    ...
    if(NOT DEFINED DEPENDENCIES_URL_1900_35)
        message(FATAL_ERROR "Could not find url for MSVC version = 1900 and Python version = ${PYTHON_VERSION_MAJOR}.${PYTHON_VERSION_MINOR}.")
    endif()
    # set the dependencies URL and SHA1
    set(DEPENDENCIES_URL ${DEPENDENCIES_URL_1900_35})
    set(DEPENDENCIES_SHA ${DEPENDENCIES_SHA_1900_35})
    set(CAFFE_DEPENDENCIES_DIR ${CAFFE_DEPENDENCIES_ROOT_DIR}/${DEPENDENCIES_NAME_1900_35})
